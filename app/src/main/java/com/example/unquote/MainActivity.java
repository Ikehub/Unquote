...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView questionTextView, questionsRemainingTextView, scoreTextView;
    private Button answer0Button, answer1Button, answer2Button, answer3Button, submitButton;

    private ImageView imgHeart1, imgHeart2, imgHeart3;
...
//        getSupportActionBar().setElevation(0);
    ...
    private void initViews() {
        ...
        scoreTextView = findViewById(R.id.tv_main_score_count);
        answer0Button = findViewById(R.id.btn_main_answer_0);
        answer1Button = findViewById(R.id.btn_main_answer_1);
        answer2Button = findViewById(R.id.btn_main_answer_2);
        answer3Button = findViewById(R.id.btn_main_answer_3);
        submitButton = findViewById(R.id.btn_main_submit_answer);
        imgHeart1 = findViewById(R.id.imgLife);
        imgHeart2 = findViewById(R.id.imgLife2);
        imgHeart3 = findViewById(R.id.imgLife3);
    }
    ...
    void onAnswerSelected(int answerSelected) {
        ...
        switch (answerSelected) {
            case 0:
                answer0Button.setText(String.format("✔ %s", currentQuestion.answer0));
                break;
            case 1:
                answer1Button.setText(String.format("✔ %s", currentQuestion.answer1));
                break;
            case 2:
                answer2Button.setText(String.format("✔ %s", currentQuestion.answer2));
                break;
            case 3:
                answer3Button.setText(String.format("✔ %s", currentQuestion.answer3));
                break;
            default:
                break;
        }
    ...
    void onAnswerSubmission() {
        ...
        if (questions.size() == 0) {
            ...
            String gameOverMessage = "You've used up all three lives, try again";
    ...
    void startNewGame() {
        ...
        // TODO: 6/23/2020 Create questions for other sections and call the methods here using a switch statement on the extra from the intent
    ...
    void setHistoryQuestions() {
        ...
        Question question3 = new Question(R.drawable.img_quote_3, "Insanely inspiring, insanely correct (maybe). Who is the true source of this inspiration?", "Nelson Mandela", "Harriet Tubman", "Mahatma Gandhi", "Nicholas Klein", 3);
        Question question4 = new Question(R.drawable.img_quote_4, "A peace worth striving for - who actually reminded us of this?", "Malala Yousafzal", "Martin Luther King Jr.", "Liu Xiaobo", "Dalai Lama", 1);
        ...
        Question question8 = new Question(R.drawable.img_quote_8, "This mayor won't get my vote - but did he actually give this advice? And if not, who did?", "Forrest Gump, Forrest Gump", "Dorry, Finding Nemo", "Esther Williams", "The Mayor, Jaws", 1);
        Question question9 = new Question(R.drawable.img_quote_9, "Her heart will go on, but whose heart is it?", "Whitney Houston", "Diana Ross", "Ceiline Dion", "Mariah Carey", 0);
        ...
        Question question12 = new Question(R.drawable.img_quote_12, "Houston, we have a problem with this quote - which space-traveller does this catch-phrase actually belong to?", "Han Solo, Star Wars", "Captain Kirk, Star Trek", "Buzz Lightyear, Toy Story", "Jim Lovell, Apollo 13", 2);
